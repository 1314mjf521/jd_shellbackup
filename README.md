...
- __2021/5/08 14:19 `更新`__\
   1、更新解决无法更新的问题，请备份好配置数据后进行重新部署
    2、由于大佬仓库私有化问题建议重新部署已更新，可正常运行。
- __2021/4/23 14:01 `更新`__\
   更新Docker镜像地址，不解释！
- __2021/4/22 14:01 `更新`__\
  1、根据问题跟踪提供DIY脚本更新内容，DIY脚本已可以正常使用，如有问题麻烦执行更新脚本或是手动更换config.sh\
  2、（大佬已回复不让引用，已经更新过请自行删除，已备份大佬库，如果有需要请自行添加自定义脚本衔接）脚本私有化问题，个别脚本是大佬不愿意分享的我虽然做进去了，但是不一定可以使用。\
  3、如更新后无法使用请重新下载[config.sh] (https://gitee.com/mjf521/JD-FreeFuck/blob/source/sample/config.sh.sample)  \
  4、更新DIY脚本位置作为加速使用

- __2021/4/19 16:55 `更新`__
  更新了面板位置错误，同时针对主页代码的个别位置的补充更新，如无特殊情况可不用更新。
- __2021/3/30 14:11 `更新`__
  更新了一些其他的东西，请大家删库重新部署，原部署仍能正常使用，现在仅更新个别位置，可以直接使用，建议所有人重新部署项目
- __2021/3/24 7:10 `更新`__
ㅤ更新了控制面板，修复了滚动条可视性的问题，调整了部分UI布局。请所有朋友执行 `git_pull` 一键更新脚本完成更新。
...
#### __下载镜像：__
    hangzhou.aliyuncs.com/supermanito/helloworld
